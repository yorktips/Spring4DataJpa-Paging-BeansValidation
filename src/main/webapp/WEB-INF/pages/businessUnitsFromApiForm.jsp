...
<head>
    ...
    <title>BusinessUnitsFromApi Information</title>
    <!-- Bootstrap CSS -->
...
<body class=".container-fluid">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">
                    BusinessUnitsFromApi Details
                </h3>
            </div>
            <div class="panel-body">
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="saveBusinessUnitsFromApi">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <input type="submit" id="saveBusinessUnitsFromApi" class="btn btn-primary" value="Save" onclick="return submitBusinessUnitsFromApiForm();"/>
                            </div>
                            <div class="col-xs-4">
                            </div>
                        </div>
	...
	<script type="text/javascript">
		function submitBusinessUnitsFromApiForm() {				
