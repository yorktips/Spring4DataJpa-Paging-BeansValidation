...
<body class=".container-fluid">
	...
	<div class="container">
	  ...
	  <div class="list-group">
	    ...
	    <a href="#" class="list-group-item list-group-item-info">Music Subscriber</a>
	    <a href="#" class="list-group-item list-group-item-warning">Business Units From Google Places API</a>
	  </div>
	</div>
